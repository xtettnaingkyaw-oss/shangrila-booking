...
ဆရာ၊ ပုံ-၁ နဲ့ ပုံ-၂ မှာပြထားတဲ့ လိုအပ်ချက်တွေကို သေချာ ပြင်ဆင်ပေးပါမယ်။

၁။ **Employee ID Auto Generate:** Form အသစ်ဖွင့်လိုက်တာနဲ့ `staffId` ကို အလိုအလျောက် (ဥပမာ - No-123) ထည့်ပေးထားပါမယ်။ အဲ့ဒီအကွက်ကို ပြင်လို့မရအောင် ပိတ်ထားပါမယ်။
၂။ **Therapist Name (Admin မှ သတ်မှတ်မည်):** ဝန်ထမ်းအမည်ရင်း သက်သက်၊ Admin ကနေ သတ်မှတ်ပေးမယ့် Therapist Name သက်သက် ဖြစ်သွားအောင် Admin ဖက်က Approve လုပ်တဲ့အချိန်မှာ Therapist Name သတ်မှတ်လို့ရမယ့် အကွက် ထပ်တိုးပေးပါမယ်။ Active Staff List မှာလည်း နာမည် ၂ မျိုးလုံး ပြပေးပါမယ်။
၃။ **Submit Button ပျောက်နေခြင်း:** Z-index သို့မဟုတ် Container Height ပြဿနာကြောင့် အောက်ကိုရောက်သွားတာဖြစ်လို့ Scroll ဆွဲလို့ရအောင် သေချာ ပြန်စီပေးပါမယ်။ ပြီးတော့ Submit ခလုတ်ကို မျက်နှာပြင်ရဲ့ အောက်ခြေမှာ (Fixed Bottom) အသေကပ်ထားပေးပါမယ်။

**`src/pages/OnboardingSystem.tsx`** ဖိုင်ကြီးတစ်ခုလုံးကို အောက်ပါကုဒ်ဖြင့် အစားထိုးလိုက်ပါခင်ဗျာ-
