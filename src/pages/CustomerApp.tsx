             ...
             {category.items.map((s) => {
                        ...
                        return (
                            <button
                                ...
                                } rounded-[1.5rem] p-3 sm:p-4 mb-4 transition-all duration-300 flex flex-col sm:flex-row gap-3 sm:gap-4 relative overflow-hidden group`}
                            >
                                {/* Selected Checkmark */}
                                {isSelected && (
                                ...
                                <div className="w-full sm:w-[130px] h-[150px] sm:h-[120px] rounded-xl overflow-hidden bg-gray-50 relative flex-shrink-0 border border-gray-100/60 shadow-inner">
                                    {s.imageUrl ? (
