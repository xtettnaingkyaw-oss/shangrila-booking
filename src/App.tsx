...
// --- Constants ---
const SERVICES = [
  { id: 'massage-60', name: 'Traditional Massage', price: '25,000 Ks', duration: '60 Mins' },
  { id: 'massage-90', name: 'Traditional Massage', price: '37,000 Ks', duration: '90 Mins' },
  { id: 'oil-60', name: 'Oil Massage', price: '25,000 Ks', duration: '60 Mins' },
  { id: 'oil-90', name: 'Oil Massage', price: '37,000 Ks', duration: '90 Mins' },
  { id: 'aroma-60', name: 'Aromatherapy Massage', price: '30,000 Ks', duration: '60 Mins' },
  { id: 'aroma-90', name: 'Aromatherapy Massage', price: '45,000 Ks', duration: '90 Mins' },
  { id: 'butter-60', name: 'Body Butter Lotion Massage', price: '35,000 Ks', duration: '60 Mins' },
];
...
function CustomerBooking() {
      ...
      <div className="flex items-center justify-center mb-10 w-full max-w-lg mx-auto">
        {steps.map((s, idx) => (
          <React.Fragment key={s.num}>
            ...
            {idx < steps.length - 1 && (
              <div className={`flex-1 h-[2px] mx-2 transition-colors duration-300 ${step > s.num ? 'bg-yellow-500' : 'bg-gray-200'}`} />
            )}
          </React.Fragment>
        ))}
      </div>
  ...
  const renderStep1 = () => (
    <div className="animate-fade-in">
      ...
      <div className="space-y-3 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <div className="flex items-center text-sm font-bold text-gray-700 pb-2 border-b border-gray-100 mb-2 px-2">
          <Activity className="w-4 h-4 mr-2" /> Massage Services
        </div>
        {SERVICES.map(s => (
          <div 
            key={s.id}
          ...
          >
            ...
            <div className="font-bold" style={{ color: THEME.primary }}>{s.price}</div>
          </div>
        ))}
      </div>
    ...
    <div className="animate-fade-in">
      ...
      >
        ...
        <div>
          ...
          <div className="text-xs text-gray-500">We'll assign the best available therapist for you</div>
        </div>
      </div>
          ...
          return (
            <div 
              ...
              className={`flex flex-col items-center p-4 rounded-xl cursor-pointer border transition-all duration-200 ${
                isSelected ? 'border-yellow-500 bg-yellow-50 shadow-md' : 'border-gray-200 bg-white hover:border-yellow-400 hover:shadow-sm'
              }`}
            >
      ...
      <div className="mt-8 flex justify-between">
        <button onClick={() => setStep(1)} className="px-6 py-3 rounded-lg font-bold text-gray-600 bg-white border border-gray-300 hover:bg-gray-50 transition">BACK</button>
        <button 
  ...
  const renderStep3 = () => (
    <div className="animate-fade-in">
      ...
      <div className="mt-8 flex justify-between">
        <button onClick={() => setStep(2)} className="px-6 py-3 rounded-lg font-bold text-gray-600 bg-white border border-gray-300 hover:bg-gray-50 transition">BACK</button>
        <button 
  ...
  const renderStep4 = () => (
    <form onSubmit={handleSubmit} className="animate-fade-in pb-10">
      ...
      {/* Summary Card */}
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-6">
        <h3 className="text-xs font-bold text-gray-400 tracking-widest uppercase mb-4">Booking Summary</h3>
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 flex justify-between items-center">
          ...
          <span className="text-xl font-bold text-yellow-600">{formData.servicePrice}</span>
        </div>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b-2 border-gray-100 text-xs text-gray-500 uppercase tracking-wider">
              ...
              <th className="p-3 pb-4">TxID & Payment</th>
            ...
            {bookings.map((b) => (
              <tr key={b.id} className="border-b border-gray-50 hover:bg-gray-50 transition">
                ...
                <td className="p-3">
                  ...
                  <div className="text-[10px] uppercase tracking-wider font-bold text-yellow-600 mt-1">{b.paymentMethod}</div>
                </td>
                <td className="p-3">
                  {b.status === 'pending' 
